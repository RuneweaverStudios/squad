	...
	<div class="modal modal-open">
		<div class="modal-box max-w-4xl max-h-[90vh] overflow-y-auto">
			...
			<div class="flex items-center justify-between mb-6">
				<h2 class="text-2xl font-bold">IDE Help Guide</h2>
				<button
			...
			<div class="space-y-8">
				...
				<section>
					...
					<div class="space-y-3 text-sm">
						<p>The IDE uses a <strong>drawer sidebar pattern</strong> for navigation. The sidebar is always visible on desktop and can be toggled on mobile devices.</p>
				...
				<section>
					...
					<div class="space-y-2 text-sm">
						<p>The IDE supports multi-project task management. Use the <strong>Project Selector</strong> in the top navigation bar to filter tasks by project.</p>
				...
				<section>
					...
					<div class="space-y-3 text-sm">
						<div>
							<p class="font-semibold">📋 List View</p>
						...
						<div>
							<p class="font-semibold">🔗 Dependency View</p>
						...
						<div>
							<p class="font-semibold">📅 Timeline View</p>
						...
						<div>
							<p class="font-semibold">📊 Kanban View</p>
						...
						<div>
							<p class="font-semibold">👥 Agents View</p>
						...
						<div class="collapse collapse-arrow bg-base-200">
							...
							<div class="collapse-content">
								...
								<ul class="list-disc list-inside mt-2 space-y-1">
									...
									<li>Use Command Palette (<kbd class="kbd kbd-sm">Cmd</kbd> + <kbd class="kbd kbd-sm">K</kbd>) → "Create Task"</li>
								</ul>
							</div>
						</div>
				...
				<section>
					...
					<div class="space-y-2 text-sm">
						<div class="alert alert-info">
							...
							<div>
								<p class="font-semibold">IDE not loading?</p>
						...
						<div class="alert alert-info">
							...
							<div>
								...
								<p class="text-xs mt-1">The IDE polls every 30 seconds. Wait a moment or refresh the page manually.</p>
							</div>
						</div>
					</div>
				</section>
