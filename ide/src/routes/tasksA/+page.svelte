...
<svelte:head>
	<title>Concept A: Tabbed | SQUAD IDE</title>
</svelte:head>

<div class="demo-page">
	<header class="demo-header">
		<h1>Concept A: Tabbed Sections</h1>
		<p>Content organized into [Details] [Activity] [Deps] tabs to reduce vertical scroll.</p>
		<a href="/tasksC" class="compare-link">Compare with Concept C →</a>
	</header>
	...
	<div class="concept-notes">
		<h3>Key Features</h3>
		<ul>
			<li><strong>Tabbed navigation</strong> - Switch between Details, Activity, and Dependencies</li>
			<li><strong>Reduced scroll</strong> - Only active tab content visible</li>
			<li><strong>Count badges</strong> - Quick visibility of activity/deps counts</li>
			<li><strong>Collapsible attachments</strong> - Expand only when needed</li>
		</ul>
		<h3>Trade-offs</h3>
		<ul>
			<li>Extra click to see activity or dependencies</li>
			<li>Can't see all info at once</li>
		</ul>
	</div>
</div>
