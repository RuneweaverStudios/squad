...
export const metadata = {
  ...
  version: '1.0.0',
  icon: {
    svg: 'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm3.611 16.738c-1.306.836-3.004 1.263-4.99 1.263h-.155c-1.47 0-2.828-.26-4.032-.77a6.87 6.87 0 01-2.88-2.206c-.746-.961-1.125-2.074-1.125-3.305 0-.793.194-1.543.577-2.228A5.92 5.92 0 014.611 7.92c.68-.467 1.467-.835 2.34-1.095a9.398 9.398 0 012.762-.396h.155c1.47 0 2.828.26 4.032.771a6.87 6.87 0 012.88 2.206c.746.961 1.125 2.074 1.125 3.305 0 .793-.194 1.543-.577 2.228a5.92 5.92 0 01-1.606 1.572c-.68.467-1.467.835-2.34 1.095a9.398 9.398 0 01-2.762.396l2.99-1.264z',
    viewBox: '0 0 24 24',
    fill: true,
    color: '#8B5CF6'
  },
