<script lang="ts">
	 ...
	 *
	 * Categories:
	 * - Agent: Commands, Tools, Projects, Templates
	 * - Settings: Autopilot, Defaults, Shortcuts, Actions, Commit
	 * - Extensions: Hooks, MCP, CLAUDE.md, Docs
	 *
	...
	const tabs: Tab[] = [
		// Agent category - core workflow tools
		{
			id: 'commands',
			label: 'Commands',
			category: 'agent',
		...
		// Settings category - preferences and behavior
		{
			id: 'swarm',
			label: 'Autopilot',
			category: 'settings',
