...
# /skill:squad-verify - Browser Verification

Test your work in a real browser using SQUAD's browser automation tools.

## Usage

```
/skill:squad-verify                           # Auto-detect what to test
/skill:squad-verify http://localhost:5173/tasks  # Test specific URL
/skill:squad-verify /tasks                     # Test specific path
```
...
- NOT for static checks (tests, lint) - those are in `/skill:squad-complete`

## Browser Tools

SQUAD includes browser automation tools in `~/.local/bin/`:
