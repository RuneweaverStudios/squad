 ...
 *
 * Unassigns a specific task from the agent using st update
 */
...
export async function POST({ params, request }) {
	try {
		...
		try {
			...
			// Unassign the task
			const updateCommand = `st update ${taskId} --assignee ""`;
